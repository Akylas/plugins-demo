...
const rechk = /^([<>])?(([1-9]\d*)?([xcbB?hHiIlLfdspqQ]))*$/;
const refmt = /([1-9]\d*)?([xcbB?hHiIlLfdspqQ])/g;
...
const lut = (le) => ({
    x: (c) => [1, c, 0],
    c: (c) => [c, 1, (o) => ({ u: (v: DataView) => str(v, o, 1), p: (v, c) => rts(v, o, 1, c) })],
    '?': (c) => [c, 1, (o) => ({ u: (v: DataView) => Boolean(v.getUint8(o)), p: (v, B) => v.setUint8(o, B) })],
    b: (c) => [c, 1, (o) => ({ u: (v: DataView) => v.getInt8(o), p: (v, b) => v.setInt8(o, b) })],
    B: (c) => [c, 1, (o) => ({ u: (v: DataView) => v.getUint8(o), p: (v, B) => v.setUint8(o, B) })],
    h: (c) => [c, 2, (o) => ({ u: (v: DataView) => v.getInt16(o, le), p: (v, h) => v.setInt16(o, h, le) })],
    H: (c) => [c, 2, (o) => ({ u: (v: DataView) => v.getUint16(o, le), p: (v, H) => v.setUint16(o, H, le) })],
    i: (c) => [c, 4, (o) => ({ u: (v: DataView) => v.getInt32(o, le), p: (v, i) => v.setInt32(o, i, le) })],
    I: (c) => [c, 4, (o) => ({ u: (v: DataView) => v.getUint32(o, le), p: (v, I) => v.setUint32(o, I, le) })],
    l: (c) => [c, 4, (o) => ({ u: (v: DataView) => v.getInt32(o, le), p: (v, i) => v.setInt32(o, i, le) })],
    L: (c) => [c, 4, (o) => ({ u: (v: DataView) => v.getUint32(o, le), p: (v, I) => v.setUint32(o, I, le) })],
    f: (c) => [c, 4, (o) => ({ u: (v: DataView) => v.getFloat32(o, le), p: (v, f) => v.setFloat32(o, f, le) })],
    d: (c) => [c, 8, (o) => ({ u: (v: DataView) => v.getFloat64(o, le), p: (v, d) => v.setFloat64(o, d, le) })],
    q: (c) => [c, 8, (o) => ({ u: (v: DataView) => v.getBigInt64(o, le), p: (v, d) => v.setBigInt64(o, BigInt(d), le) })],
    Q: (c) => [c, 8, (o) => ({ u: (v: DataView) => v.getBigUint64(o, le), p: (v, d) => v.setBigUint64(o, BigInt(d), le) })],
    s: (c) => [1, c, (o) => ({ u: (v: DataView) => str(v, o, c), p: (v, s) => rts(v, o, c, s.slice(0, c)) })],
    p: (c) => [1, c, (o) => ({ u: (v: DataView) => pst(v, o, c), p: (v, s) => tsp(v, o, c, s.slice(0, c - 1)) })]
});
...
export default function struct(format) {
    ...
    const pack = (...values) => {
        const b = createArrayBuffer(size, true, false).buffer;
